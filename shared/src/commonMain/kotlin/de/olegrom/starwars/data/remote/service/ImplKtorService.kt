...
class ImplKtorService(
    ...
    override suspend fun getFilms(page: Int): FilmsDTO = httpClient.get("$baseUrl/${EndPoints.FILMS}/?page=${page}") {}.body()
    override suspend fun getStarships(page: Int): StarshipsDTO = httpClient.get("$baseUrl/${EndPoints.STARSHIPS}/?page=${page}") {}.body()
    ...
    override suspend fun getPersons(page: Int): PersonsDTO = httpClient.get("$baseUrl/${EndPoints.PEOPLES}/?page=${page}") {}.body()
    override suspend fun getPlanets(page: Int): PlanetsDTO = httpClient.get("$baseUrl/${EndPoints.PLANETS}/?page=${page}") {}.body()
