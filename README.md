...
It uses Gradle as the build system. Dependencies and change settings are in shared/build.gradle.kts. 
The shared module builds into an Android library and an iOS framework.

shared/commonTest/de/olegrom/starwars contains tests for the shared view models
